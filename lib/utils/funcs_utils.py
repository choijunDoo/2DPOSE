...
def resize_joints(joints, orig_size, new_size):
    scale_x = new_size[0] / orig_size[1] # (512 / 1080)
    scale_y = new_size[1] / orig_size[0] # (512 / 1920)
    
    resized_joints = joints.copy()
    resized_joints[:, 0] *= scale_x
    resized_joints[:, 1] *= scale_y
